...
# num3 = int(input("Enter for number 3\n"))
# num4 = int(input("Enter for number 4\n"))
...
# names = ["Sachin","Mohit","Gaurav","Parveen","Neeraj"]
# name = input("Enter your name\n")

# if name in names:
#     print("You're a member of NSPG")
# else:
